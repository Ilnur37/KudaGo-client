...
import {CommentTheaterService} from "../../../service/comment-theater.service";
import {TheaterEditComponent} from "../../admin/theater-edit/theater-edit.component";
...
export class TheaterInfoComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute,
              ...
              private commentService: CommentTheaterService,
  ...
  openEditDialog(): void {
    ...
    this.dialog.open(TheaterEditComponent, dialogPostEditConfig);
  }
}
